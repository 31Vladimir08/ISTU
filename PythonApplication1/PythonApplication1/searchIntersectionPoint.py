...
class SearchIntersectionPoint:
    ...
    def return_list_intersection_points(self, a, b, c, d, point_start, point_finish, y):
        ...
        if (count == 0):
            point_added = self.return_intersection_point(a, b, c, d, point_start, point_finish, y)
            ...
            if ((point_start < list_extremum_x[0] and point_finish < list_extremum_x[0]) or (point_start >= list_extremum_x[0] and point_finish > list_extremum_x[0])):
                ...
                point_added = self.return_intersection_point(a, b, c, d, point_start, list_extremum_x[0], y)
                if (point_added is not None):
                    list_intersection_points.append(point_added)
                point_added = self.return_intersection_point(a, b, c, d, list_extremum_x[0], point_finish, y)
                if (point_added is not None):
                    list_intersection_points.append(point_added)
        else:
    ...
    def return_intersection_point(self, a, b, c, d, pointStart, pointFinish, y):
        ...
        intersection_point.coordinate_y = gfun.GraphFunctions().return_fun_x(a, b, c, d, intersection_point.coordinate_x) if (intersection_point.coordinate_x is not None) else None
